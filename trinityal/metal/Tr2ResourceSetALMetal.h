...
public:
	...
	ALResult Create( const Tr2ResourceSetDescriptionAL& description,
...
private:
	id<MTLBuffer> m_buffers[Tr2RenderContextEnum::SHADER_TYPE_COUNT]
						   [Tr2ResourceSetDescriptionAL::MAX_RESOURCES_IN_STAGE];
	id<MTLTexture> m_textures[Tr2RenderContextEnum::SHADER_TYPE_COUNT]
							 [Tr2ResourceSetDescriptionAL::MAX_RESOURCES_IN_STAGE];
	id<MTLSamplerState> m_samplers[Tr2RenderContextEnum::SHADER_TYPE_COUNT]
								  [Tr2ResourceSetDescriptionAL::MAX_RESOURCES_IN_STAGE];
