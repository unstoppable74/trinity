...
class Publish(perforce_publish_path: String) : BuildType({
    ...
    params {
        ...
        param("env.EXECUTABLE_FILENAMES_MATCH", "CarbonMeshViewer,CarbonMeshViewer_debug,CarbonMeshViewer_internal,CarbonMeshViewer_trinitydev,cmfprocessor,cmfprocessor_debug,cmfprocessor_internal,cmfprocessor_trinitydev")
