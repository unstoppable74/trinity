# This is a copy of OpenVDB from microsoft vcpkg registry
# It adds an extra feature to build without CUDA
vcpkg_from_github(
...
vcpkg_check_features(
    ...
    FEATURES
        ...
        "nanovdb-nocuda" OPENVDB_BUILD_NANOVDB
)
...
if ("nanovdb" IN_LIST FEATURES)

    list(APPEND NANOVDB_OPTIONS 
        -DNANOVDB_USE_CUDA=ON
        -DNANOVDB_CUDA_KEEP_PTX=ON
    )

elseif("nanovdb-nocuda" IN_LIST FEATURES)
