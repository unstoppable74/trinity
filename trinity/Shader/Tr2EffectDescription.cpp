...
Tr2EffectStageInput::Tr2EffectStageInput() :
	m_exists( false ), samplers( "Tr2EffectStageInput::samplers" ), resources( "Tr2EffectStageInput::resources" ), uavs( "Tr2EffectStageInput::uavs" ), constants( "Tr2EffectStageInput::constants" ), annotation( "Tr2EffectStageInput::annotation" ), m_shader( INVALID ), m_constantValueSize( 0 )
{
	constantValues[0] = 0;
}
