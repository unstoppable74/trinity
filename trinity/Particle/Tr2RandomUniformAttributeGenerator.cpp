...
#include "StdAfx.h"
#include "Tr2RandomUniformAttributeGenerator.h"
#include "Tr2ParticleSystem.h"

// --------------------------------------------------------------------------------------
// Description:
//   Tr2RandomUniformAttributeGenerator default constructor
// --------------------------------------------------------------------------------------
Tr2RandomUniformAttributeGenerator::Tr2RandomUniformAttributeGenerator() :
...
// --------------------------------------------------------------------------------------
// Description:
//   Tr2RandomUniformAttributeGenerator destructor
// --------------------------------------------------------------------------------------
Tr2RandomUniformAttributeGenerator::~Tr2RandomUniformAttributeGenerator()
{
}
...
// --------------------------------------------------------------------------------------
void Tr2RandomUniformAttributeGenerator::Generate( const Vector3* position,
												   ...
												   float** particle )
{
	...
	{
		data[i] = m_minRange[i] + ( m_maxRange[i] - m_minRange[i] ) * Tr2ParticleSystem::RandFloat();
	}
}
...
//   false Otherwise
// --------------------------------------------------------------------------------------
bool Tr2RandomUniformAttributeGenerator::Bind(
...
// --------------------------------------------------------------------------------------
std::string Tr2RandomUniformAttributeGenerator::GetName() const
{
...
// --------------------------------------------------------------------------------------
unsigned Tr2RandomUniformAttributeGenerator::GetDimension() const
{
