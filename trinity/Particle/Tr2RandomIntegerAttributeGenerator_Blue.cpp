...
BLUE_DEFINE( Tr2RandomIntegerAttributeGenerator );

const Be::ClassInfo* Tr2RandomIntegerAttributeGenerator::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2RandomIntegerAttributeGenerator, "" )
