...
BLUE_DEFINE( Tr2RandomUniformAttributeGenerator );

const Be::ClassInfo* Tr2RandomUniformAttributeGenerator::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2RandomUniformAttributeGenerator, "" )
		MAP_INTERFACE( Tr2RandomUniformAttributeGenerator )
